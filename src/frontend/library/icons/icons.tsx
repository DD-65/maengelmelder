...
export function LikeIcon({ className, title, style }: IconProps) {
  return (
    <svg 
    xmlns="http://www.w3.org/2000/svg" 
    fill="none" 
...
export function ModifyIcon({ className, title, style }: IconProps) {
  return (
    <svg 
    xmlns="http://www.w3.org/2000/svg" 
    fill="none" 
...
export function SendIcon({ className, title, style }: IconProps) {
  return (
    <svg 
    xmlns="http://www.w3.org/2000/svg" 
    fill="none" 
